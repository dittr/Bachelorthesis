 ...
 \subsection{Experimental Setup}
  ...
  \begin{center}
   \begin{tikzpicture}[roundnode/.style={circle, draw=green!60, fill=green!5, very thick, minimum size=7mm},
  					 roundnodesmall/.style={circle, draw=green!60, fill=green!5, thick, minimum size=1mm, node distance=0.2cm}]
    % Node
    \node[roundnodesmall] (root) {};

    \node[roundnodesmall] (Autoencoder) [below left=0.5cm and 0.5cm of root] {};
    \node[roundnodesmall] (PredNet) [below=0.4cm of root] {};
    \node[roundnodesmall] (Spatiotemp) [below right=0.5cm and 0.5cm of root] {};

    \node[roundnodesmall] (convlstm_autoenc) [below left=of Autoencoder] {};
    \node[roundnodesmall] (predrnn_autoenc) [below right=of Autoencoder] {};
    \node[roundnodesmall] (convlstm_prednet) [below left=of PredNet] {};
    \node[roundnodesmall] (predrnn_prednet) [below right=of PredNet] {};
    \node[roundnodesmall] (convlstm_spatiotemp) [below left=of Spatiotemp] {};
    \node[roundnodesmall] (predrnn_spatiotemp) [below right=of Spatiotemp] {};

	\node[roundnodesmall] (convlstm_autoenc_mnist) [below left=of convlstm_autoenc] {};
	\node[roundnodesmall] (convlstm_autoenc_kth) [below=of convlstm_autoenc] {};
	\node[roundnodesmall] (convlstm_autoenc_kitti) [below right=of convlstm_autoenc] {};	
	\node[roundnodesmall] (predrnn_autoenc_mnist) [below left=of predrnn_autoenc] {};
	\node[roundnodesmall] (predrnn_autoenc_kth) [below=of predrnn_autoenc] {};
	\node[roundnodesmall] (predrnn_autoenc_kitti) [below right=of predrnn_autoenc] {};
	\node[roundnodesmall] (convlstm_prednet_mnist) [below left=of convlstm_prednet] {};
	\node[roundnodesmall] (convlstm_prednet_kth) [below=of convlstm_prednet] {};
	\node[roundnodesmall] (convlstm_prednet_kitti) [below right=of convlstm_prednet] {};
	\node[roundnodesmall] (predrnn_prednet_mnist) [below left=of predrnn_prednet] {};
	\node[roundnodesmall] (predrnn_prednet_kth) [below=of predrnn_prednet] {};
	\node[roundnodesmall] (predrnn_prednet_kitti) [below right=of predrnn_prednet] {};
	\node[roundnodesmall] (convlstm_spatiotemp_mnist) [below left=of convlstm_spatiotemp] {};
	\node[roundnodesmall] (convlstm_spatiotemp_kth) [below=of convlstm_spatiotemp] {};
	\node[roundnodesmall] (convlstm_spatiotemp_kitti) [below right=of convlstm_spatiotemp] {};
	\node[roundnodesmall] (predrnn_spatiotemp_mnist) [below left=of predrnn_spatiotemp] {};
	\node[roundnodesmall] (predrnn_spatiotemp_kth) [below=of predrnn_spatiotemp] {};
	\node[roundnodesmall] (predrnn_spatiotemp_kitti) [below right=of predrnn_spatiotemp] {};
    % Lines
    \draw[->] (root) -- (Autoencoder);
    \draw[->] (root) -- (PredNet);
    \draw[->] (root) -- (Spatiotemp);
    
    \draw[->] (Autoencoder) -- (convlstm_autoenc);
    \draw[->] (Autoencoder) -- (predrnn_autoenc);
    \draw[->] (PredNet) -- (convlstm_prednet);
    \draw[->] (PredNet) -- (predrnn_prednet);
    \draw[->] (Spatiotemp) -- (convlstm_spatiotemp);
    \draw[->] (Spatiotemp) -- (predrnn_spatiotemp);
