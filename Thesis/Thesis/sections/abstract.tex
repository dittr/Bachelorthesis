...
with the more advanced solution PredRNN \cite{Wang2017}, to see if the usage of a more advanced recurrent sub-module will increase the accuracy. The algorithms are therefore re-implemented in PyTorch \cite{Paszke2019}, which is described in-depth for the reader.